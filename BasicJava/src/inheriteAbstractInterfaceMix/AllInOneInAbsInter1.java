package inheriteAbstractInterfaceMix;

interface Dadar{
	int age=25;    // public static final int age =25;
	void printing(); // public abstract void printing();
}
abstract class Mumbai{      //abstract class
	abstract void calling(int num);  //abstract parameterized method incomplete
}
...
public class AllInOneInAbsInter1 {
	public static void main(String[] args) {
		Pune p1=new Pune();
		p1.deccan();
		p1.businessHub();
		System.out.println("*************************");
		Maharastra m1=new Maharastra(25);
		m1.businessHub();
		m1.display();
		System.out.println("************************");
