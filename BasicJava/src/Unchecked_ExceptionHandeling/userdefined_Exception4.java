package Unchecked_ExceptionHandeling;
	...
	public class userdefined_Exception4 {
		
		public static void validateAge(int age) throws UserDefinedException {  //method
			...
			if (age < 18) 
			{
				System.out.println("person not eligible to vote");
 				               ...
 				               // throw Arithmetic exception if not eligible to vote					throw new UserDefinedException("Person is not eligible to vote");
