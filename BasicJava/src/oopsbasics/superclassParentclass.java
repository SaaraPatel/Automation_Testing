...
class B1 extends A1{
	...
	static int x=30;                   // static var
	int y=40;                          // Non static
	double z=53.45;                     // Non static
}
//C1 inherits class B1 non-static members
class C1 extends B1{
	//java compiler will write default constructor with default super statement
	static int p=50;                      // static
	int q=60;                            //// Non static
	double r=66.45;                     // Non static
}

 
public class superclassParentclass {     // main class for main method

	public static void main(String[] args) {

//can directly access static variable with each class name		
...
//Non static var access by object with respective class name		
