...
// list inherate the arrylist	
	ArrayList list = new ArrayList();// Creating arraylist - default size is 10
// Arrylist is collection of homogenious,hetrogenous data
	...
	list.add(new ArrayList0());// ArrayListExample0 class object will be upcasted to Object class object
	list.add("Banana");//duplicate it allow
	...
	list.set(1, "Dates"); //index 1 update by dates
	System.out.println("size of list: " + list.size());
	System.out.println("Elements of list: " + list);
